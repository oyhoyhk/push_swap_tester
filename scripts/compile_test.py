...
def test_make_re(id:str):
	...
	try :
		...
		subprocess.run(['make', 're'], stdout=subprocess.PIPE, stderr=subprocess.PIPE, text=True)
...
def test_make_clean(id:str):
	...
	try :
		...
		subprocess.run(['make', 'clean'], stdout=subprocess.PIPE, stderr=subprocess.PIPE, text=True)
...
def test_make_fclean(id:str):
	...
	try :
		...
		subprocess.run(['make', 'fclean'], stdout=subprocess.PIPE, stderr=subprocess.PIPE, text=True)
		for root, dirs, files in os.walk(os.getcwd()):
			for file in files:
